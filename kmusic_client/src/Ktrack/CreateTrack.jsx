...
const handleSubmit = async (event, createTrack) => {
  ...
  createTrack({ variables: { tittle, description, url: uploadedUrl } });
};
...
const CREATE_TRACK_MUTATION = gql`
  mutation($tittle: String!, $description: String!, $url: String!) {
    createTrack(tittle: $tittle, description: $description, url: $url) {
      ktrack {
        id
        tittle
        description
